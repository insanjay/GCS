...
class HandTracker:
    def __init__(
        ...
        self.HAND_CONNECTIONS = [
            ...
            (
                11,
                12,
            ),  # Middle (Note: 0-9 usually not drawn in favor of 5-9) -- actually MP standard is 0-9 too.
            (9, 13),
            (13, 14),
            (14, 15),
            (15, 16),  # Ring
    ...
    def find_hands(self, img, draw=True):
        ...
        mp_image = mp.Image(
            image_format=mp.ImageFormat.SRGB, data=cv2.cvtColor(img, cv2.COLOR_BGR2RGB)
        )
